...
const apps = [
  {
    ...
    color: "bg-green-500",
    features: [
      { icon: Battery, text: "Real-time battery percentage display" },
      { icon: Clock, text: "Accurate time remaining estimates" },
  ...
  },
  {
    ...
    features: [
      ...
      { icon: Layers, text: "Full drag & drop support" },
      { icon: Shield, text: "Privacy-focused, stored locally" },
      ...
      <div id="github-repos" className="mt-20 pt-16 border-t">
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">Open Source</h2>
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              Simple, powerful, and open macOS utilities
            </p>
        </div>
